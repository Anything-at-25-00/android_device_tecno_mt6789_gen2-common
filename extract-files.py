...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib*/hw/audio.primary.mediatek.so', 'vendor/bin/hw/mt6789/camerahalserver', 'vendor/lib64/hw/mt6789/android.hardware.camera.provider@2.6-impl-mediatek.so',
